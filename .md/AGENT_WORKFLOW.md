...
- 공통 정책 문서: 최대 200줄
- 기능·구현 프롬프트(`.md/PROMPT_ARCHITECTURE.md`, `.md/PROMPT_IMPLEMENTATION*.md`): 줄 수 상한 없음. 기능 프롬프트는 설계에 관여하지 않는 동작 계약의 완결성을, 구현 프롬프트는 구현자가 추가 설계 판단 없이 작업할 수 있는 완결성을 우선한다.
